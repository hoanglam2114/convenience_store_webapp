                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="import-to-inventory" method="post" data-toggle="validator">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <c:set var="product" value="${sessionScope.product}"/>
                                                            <label>Tên sản phẩm</label>
                                                            <input type="hidden" name="idPro" class="form-control"
                                                                   value="${product.id}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="quantity" class="form-control"
                                                                   placeholder="Nhập số lượng muốn nhập kho"
