                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${listshop}" var="s">
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/img/shop/${s.getShopLogo()}" width="80px"
                                                     height="80px"/>
                                            </td>
                                            <td>
                                                <a href="UpdateShop?shop_id=${s.getShopId()}"
                                                   class="btn btn-sm btn-info mb-1">Sửa</a><br/>
                                                <a href="#" onclick="doDelete(${s.getShopId()})"
