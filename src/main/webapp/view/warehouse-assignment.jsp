...
<html
    ...
    <head>
        ...
        <style>
            ...
            /* Modal (override inline style if used as modal-content block) */
            .modal-content {
                                ...
                                <c:when test="${isWarehouseDetail}">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <h4 class="fw-bold mb-0">
                                            <span class="text-muted fw-light">Quản Lý / Kho hàng /</span> Chi Tiết Kho Hàng
                                        </h4>
                                        <a href="${pageContext.request.contextPath}/warehouse-assignment" class="btn btn-outline-secondary">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title mb-4"> Thông tin kho hàng </h5>
                                            <div class="row g-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="form-label">Tên kho</label>
                                                    <input type="text" class="form-control" value="${warehouseInfo.warehouseName}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Địa chỉ</label>
                                                    <input type="text" class="form-control" value="${warehouseInfo.warehouseAddress}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Điện thoại</label>
                                                    <input type="text" class="form-control" value="${warehouseInfo.warehousePhone}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Giờ làm việc</label>
                                                    <input type="text" class="form-control" value="${warehouseInfo.warehouseWorkingHours}" readonly>
                                                </div>
                                            </div>
...
<!--                                                    <div class="text-center mt-3">
                                                        <button class="view-detail-btn" onclick="viewAssignmentDetail(${assignment.assignmentId})">
                                                            Xem chi tiết
                                                        </button>
                                                    </div>        -->
                                                </div>
