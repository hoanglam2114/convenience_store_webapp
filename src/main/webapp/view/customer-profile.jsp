                ...
                <div class="profile-avatar">
                    <c:choose>
                        <c:when test="${customer.avatarUrl != null}">
                            <img src="uploads/${customer.avatarUrl}" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                        </c:when>
                        <c:otherwise>
            ...
            <div class="card info-card">
                ...
                <div class="card-footer bg-transparent p-4">
                    <div class="text-center">
                        <button type="button" class="btn btn-action btn-primary-custom" data-bs-toggle="modal"
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="gender" name="gender">
                            ...
                            <option value="Khác" ${sessionScope.customer.gender == 'Khác' ? 'selected' : ''}>Khác</option>
                        </select>
                    </div>
                    <div class="mb-3">
