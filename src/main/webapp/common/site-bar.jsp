...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="HomeAdmin" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">ConVeMa</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div data-i18n="Management">Others Management</div>
            </a>

            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="couponManage" class="menu-link">
                        <div data-i18n="Basic">Coupon Management</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="emailTemplates" class="menu-link">
                        <div data-i18n="Employee Management">EmailTemplate Management</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            <a href="admin-post-manage" class="menu-link">
