...
public class Shifts {
    ...
    public Shifts(int shiftManageId, LocalDateTime shiftStartTime, LocalDateTime shiftEndTime, BigDecimal totalRevenue, BigDecimal totalHours, String note, int employeeId, String employeeName) {
