...
/**
 * @author hoang on 6/8/2025-7:38 PM
 * IntelliJ IDEA
 */
@WebServlet(name = "UpdateSupplierServlet", urlPatterns = {"/update-supplier"})
@MultipartConfig(
...
public class UpdateSupplierServlet extends  HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/view/update-supplier.jsp").forward(request, response);
