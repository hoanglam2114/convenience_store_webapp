...
<head>
  ...
  <script type="text/javascript">
    function doDelete(id) {
      if (confirm("Bạn có chắc chắn xóa nhà cung cấp có id =" + id)) {
                ...
                <div class="col-lg-12">
                  <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                      ...
                      <p class="mb-0">Bản ghi chép chi tiết về tất cả các hoạt động xuất và nhập hàng hóa trong
                        kho theo thời gian.</p>
                    </div>
