                            ...
                            <div class="card-body">
                                <form action="emailTemplates" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="6" placeholder="Nhập nội dung" required name="content">${template.content}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Variables</label>
                                        <input type="text" class="form-control" placeholder="Ví dụ: {username}, {code} (phân cách bằng dấu phẩy)" name="variables" value="${template.variables}">
                                    </div>
