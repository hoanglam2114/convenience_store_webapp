                    ...
                    <div class="content-wrapper">
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <form action="filterShiftByDate" method="GET" class="d-flex justify-content-end gap-2 align-items-center">
                                        <label for="startDate" class="form-label me-2 mb-0">Từ:</label>
                                        <input type="date" id="startDate" name="startDate" class="form-control border-success" />

                                        <label for="endDate" class="form-label me-2 ms-3 mb-0">Đến:</label>
                                        <input type="date" id="endDate" name="endDate" class="form-control border-success" />

                                        <button class="btn btn-outline-primary ms-2" type="submit">📅 Lọc</button>
                                    </form>
