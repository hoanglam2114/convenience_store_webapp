                ...
                <div class="col-sm-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form action="update-supplier" method="post" data-toggle="validator"
                            enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label>Mã nhà cung cấp</label>
                              <input type="number" readonly name="idSup" class="form-control"
                                     value="${sup.getId()}">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <label>Địa chỉ</label>
                              <input type="text" name="addressSup" class="form-control"
                                     value="${sup.getAddress()}">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
