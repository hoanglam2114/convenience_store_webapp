                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <a href="list-store-stock" class="btn btn-primary add-list"><i
                                                    class="las la-plus mr-3"></i>Danh
                                                sách sản phẩm trong cửa hàng</a>
                                        </div>
                                        <div class="card-body">
                                            <c:set var="i" value="${inventory}"/>
                                            <c:set var="s" value="${store}"/>
                                            <form action="export-old-batch" method="post" data-toggle="validator">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly name="nameProduct"
                                                                   class="form-control"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="quantity" class="form-control"
                                                                   ...
                                                                   data-errors="Please Enter Quantity."
                                                                   required>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
