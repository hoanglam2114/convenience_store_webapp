...
/**
 * @author hoang on 6/8/2025-1:16 PM
 * IntelliJ IDEA
 */
@WebServlet(name = "FindProductStoreServlet", urlPatterns = {"/find-product-store"})
public class FindProductStoreServlet extends HttpServlet {
    /**
