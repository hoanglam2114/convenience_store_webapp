...
public class AddCustomerPosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Customers newCustomer = new Customers(name, phone, 0, 1);
        dao.addCustomer(newCustomer);

        // Tìm lại khách hàng bằng số điện thoại để lấy ID
        Customers saved = dao.findByPhone(phone);
        ...
        session.setAttribute("customerName", saved.getName());
