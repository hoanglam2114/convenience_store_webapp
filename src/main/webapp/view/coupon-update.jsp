                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 update-coupon-col">
                            <div class="card p-lg-4 p-3 mb-4">
                                ...
                                <div class="card-body">
                                    <form action="couponUpdate" method="post" autocomplete="off">
                                        <input type="hidden" name="couponId" value="${coupon.coupon_id}" />
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                <label class="form-label">Code</label>
                                                <input type="text" class="form-control" name="code" value="${coupon.coupon_code}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Discount Percentage (%)</label>
                                                <input type="number" class="form-control" name="discountPercentage" value="${coupon.discount_amount}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Start Date</label>
                                                <input type="date" class="form-control" name="startDate" value="${coupon.coupon_start_date}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">End Date</label>
                                                <input type="date" class="form-control" name="endDate" value="${coupon.coupon_end_date}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Status</label>
                                                <select name="status" class="form-select">
                                                    <c:forEach items="${statuses}" var="status">
                                                        <option value="${status}" ${status.equalsIgnoreCase(coupon.coupon_status) ? 'selected' : ''}>${status}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
