 ...
 * @author nguye
 */
@WebServlet(name="CouponManageServlet", urlPatterns={"/couponManage"})
public class CouponManageServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("statuses", couponDAO.getStatuses());
        request.getRequestDispatcher("view/coupon-list.jsp").forward(request, response);
    } 
