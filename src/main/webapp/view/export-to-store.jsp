                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <a href="list-store-stock" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Danh
                                                sách sản phẩm trong cửa hàng</a>
                                        </div>
                                        <div class="card-body">
                                            <form action="export-new-to-store" method="post" data-toggle="validator">
                                                ...
                                                <button type="submit" class="btn btn-primary mr-2">Thêm sản phẩm mới lên cửa hàng
                                                </button>
